...
@Component({
  ...
  template: `<div class="vstack">
                ...
                <div class="d-flex flex-row-reverse"><button type="button" class="btn btn-primary" (click)="onSubmit()">Post</button>
                </div></div>`,
...
export class CommentWriterComponent {
  ...
  onSubmit(){
    this.commentService.shipContentComment(this.commentDraft,this.threadName).subscribe((out) =>
    {console.log(out);
        location.reload()})
  }
